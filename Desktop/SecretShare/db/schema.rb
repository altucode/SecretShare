...
ActiveRecord::Schema.define(version: 20140815182030) do
  ...
  add_index "secret_taggings", ["secret_id", "tag_id"], name: "index_secret_taggings_on_secret_id_and_tag_id", unique: true, using: :btree
